...
public class RetrofitException extends RuntimeException {
    ...
    public static RetrofitException networkError(IOException exception) {
        String message = Application.getInstance().getResources().getString(R.string.network_error);
        return new RetrofitException(message, null, null, Kind.NETWORK, exception, null);
    }

    public static RetrofitException unexpectedError(Throwable exception) {
        String message = Application.getInstance().getResources().getString(R.string.unexpected_error);
